...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<Long> nodeList = new ArrayList<>();

    GraphDB.Node curNode;
    boolean flag = false;
    String wayName;
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            curNode = new GraphDB.Node(Long.parseLong(attributes.getValue("id")),
...
//            System.out.println("Finishing a way...");
            if (flag) {
                ...
                for (int i = 0; i < nodeList.size() - 1; i++) {
                    if (wayName != null) {
                        g.addEdge(nodeList.get(i), nodeList.get(i + 1), wayName);
                    } else {
                        g.addEdge(nodeList.get(i), nodeList.get(i + 1));
                    }
                }
            }
            nodeList.clear();
